...
3. Notion Data Source ID
   ...
   2. Open the database, click the **Settings** (gear) icon at the top, then select **Manage data sources**.
   3. Click the **Copy data source ID** button to get the identifier.
